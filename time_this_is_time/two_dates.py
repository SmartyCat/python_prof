...
Программа должна выбрать из двух введенных дат меньшую и вывести ее в формате DD-MM
(YYYY) ."""
d1, d2 = input(), input()

print(min(date.fromisoformat(d1), date.fromisoformat(d2)).strftime("%d-%m (%Y)"))
